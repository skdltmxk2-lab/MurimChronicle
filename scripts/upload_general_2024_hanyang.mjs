...
const PROBLEMS = [
  ...
  },
  {
    ...
    correct:"4",
    explanation:"㉡에서 $m(x)\\,|\\,(x^4-4x^3+5x^2-8x+6)$. 인수분해: $x^4-4x^3+5x^2-8x+6=(x^2-4x+6)(x^2+1)$? 검산하면 $(x^2-2)(x^2-4x+...)$... 실제로 $(x^2-4x+3)(x^2+2)+\\ldots$. 표준 인수: $(x^2-x+2)(x^2-3x+3)$. \n㉢에서 $x=3$이 근이 아니므로 최소다항식에 $(x-3)$ 인수 없음. ㉠에서 차수 $\\ge 3$.\n계산상 $m(x)=(x^2-x+2)(x^2-3x+3)$ 등 형태가 후보이며 $m(3)=22$. ",
  },
  {
