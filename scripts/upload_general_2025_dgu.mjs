...
const problems = [
  ...
  build({ num: 8, subject: "적분학", unit: "정적분의 계산", concept: "Leibniz 미분", difficulty: "medium",
    question: "함수 $f(x)$가 양수의 집합에서 연속이고 모든 실수 $t$에 대하여 $\\displaystyle\\int_{1+t}^{e^x+t}f(x-t)\\,dx=4e^{3t}\\sin t$를 만족한다. $f'(e^x)$의 값은?",
    options: [o("1","$e^{-x/2}$"),o("2","$2e^{-x/2}$"),o("3","$3e^{-x/2}$"),o("4","$4e^{-x/2}$"),o("5","$5e^{-x/2}$")], answer: 2,
    explanation: "변수 변환과 양변 미분 후 정리하면 $f'(e^x)=2e^{-x/2}$." }),
