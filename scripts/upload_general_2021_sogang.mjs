...
const PROBLEMS = [
  ...
  {n:7, subject:"다변수함수", unit:"선적분과 면적분", concept:"그린정리 극좌표",
    difficulty:"hard",
    question:"그림과 같이 $C$가 $P(1,0)$에서 $Q(2,0)$까지의 선분, $Q$에서 $R(0,2)$까지의 중심이 원점이고 반지름이 $2$인 원의 호, $R$에서 $S(0,1)$까지의 선분, 그리고 $S$에서 $P$까지의 중심이 원점이고 반지름이 $1$인 원의 호로 이루어진 곡선일 때, 선적분 $\\displaystyle\\int_C(2x^2y^2+y^4)\\,dx+(ye^{-2y})\\,dy$의 값은?",
