...
const problems = [
  ...
  build({
    ...
    answer: 3,
    explanation: "$v_1-v_2=w_2-w_1\\in V\\cap W$이다. 두 부분공간의 생성벡터를 행렬로 두고 연립하면 $V\\cap W=\\operatorname{span}\\{(0,1,0,0)\\}$이다. 따라서 $v_1-v_2=(0,t,0,0)$로 둘 수 있고 $v_2=(3,2-t,1,3)$, $w_2=(3,3+t,3,0)$이다. 내적은 $v_2\\cdot w_2=9+(2-t)(3+t)+3=18-t-t^2=-\\left(t+\\dfrac12\\right)^2+\\dfrac{73}{4}$이므로 최댓값은 $\\dfrac{73}{4}$이다."
  }),
  build({
