...
const problems = [
  ...
  build({
    ...
    answer: 4,
    explanation: "내부 임계점은 $f_x=2x(1+y)=0$, $f_y=2y+x^2=0$에서 $(0,0)$이고 이때 $f=4$이다. 경계 $y=1$에서는 $f(x,1)=2x^2+5$라서 범위가 $[5,7]$이고, $y=-1$에서는 $f(x,-1)=5$이다. 또 $x=\\pm1$에서는 $f(\\pm1,y)=y^2+y+5$이므로 $[-1,1]$에서 최댓값은 $7$, 최솟값은 $19/4$이다. 따라서 전체 최솟값은 $m=4$, 최댓값은 $M=7$이고 $M+m=11$이다."
  }),
  build({
